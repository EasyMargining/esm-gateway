...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "EasyMargining@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "EasyMargining API";

        private String description = "EasyMargining API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "EasyMargining";
